...
!(function (e, t) {
        ...
        w.each(
            {
                ...
                contents: function (e) {
                    return null != e.contentDocument && r(e.contentDocument)
                        ? e.contentDocument
                        : (k(e, "template") && (e = e.content || e), w.merge([], e.childNodes));
                },
            },
            function (e, t) {
                w.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 && (H[e] || w.uniqueSort(i), L.test(e) && i.reverse()),
                        this.pushStack(i)
                    );
                };
            }
    ...
    (w.Callbacks = function (e) {
        ...
        w.extend({
            ...
            when: function (e) {
                ...
                if (
                    t <= 1 &&
                    (F(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(o[n] && o[n].then))
                )
                    return a.then();
        ...
        w.extend({
            ...
            ready: function (e) {
                (!0 === e ? --w.readyWait : w.isReady) ||
                    ((w.isReady = !0), (!0 !== e && --w.readyWait > 0) || I.resolveWith(v, [w]));
            },
        }),
        (w.ready.then = I.then),
    ...
    var W = function (e, t, n, r, i, o, a) {
            var s = 0,
                u = e.length,
                l = null == n;
            if ("object" === x(n)) for (s in ((i = !0), n)) W(e, t, s, n[s], !0, o, a);
            else if (
                void 0 !== r &&
                ((i = !0),
                h(r) || (a = !0),
    ...
    function be(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; (o = p[d++]); )
            ...
            else if (((l = ie(o)), (a = me(f.appendChild(o), "script")), l && ye(a), n))
    ...
    function Ae(e, t, n) {
        n
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          if (a.length) (w.event.special[t] || {}).delegateType && e.stopPropagation();
                              ...
                              (r = n(this, t)),
                              this[t](),
                              a !== (o = K.get(this, t)) || r ? K.set(this, t, !1) : (o = {}),
                              a !== o)
                          )
            ...
            : void 0 === K.get(e, t) && w.event.add(e, t, Te);
    }
    (w.event = {
        global: {},
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && k(t, "input") && Ae(t, "click", Te), !1;
                },
                trigger: function (e) {
                    var t = this || e;
            ...
            e && e.type
                ? ((this.originalEvent = e),
                  ...
                  (this.isDefaultPrevented =
                      e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Te : Ce),
    ...
    function Pe(e, t, n, r) {
        ...
        var i,
            ...
            v = t[0],
            m = h(v);
        if (m || (p > 1 && "string" == typeof v && !d.checkClone && De.test(v)))
        ...
        if (
            p &&
            ((a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = a), a || r)
        ) {
            for (u = (s = w.map(me(i, "script"), qe)).length; f < p; f++)
                (l = i), f !== g && ((l = w.clone(l, !0, !0)), u && w.merge(s, me(l, "script"))), n.call(e[f], l, f);
            if (u)
    ...
    function Me(e, t, n) {
        for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || w.cleanData(me(r)),
                r.parentNode && (n && ie(r) && ye(me(r, "script")), r.parentNode.removeChild(r));
        return e;
    }
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(d.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e)))
                for (a = me(s), r = 0, i = (o = me(e)).length; r < i; r++) Oe(o[r], a[r]);
            if (t)
                if (n) for (o = o || me(e), a = a || me(s), r = 0, i = o.length; r < i; r++) He(o[r], a[r]);
                else He(e, s);
            ...
            html: function (e) {
                return W(
                    ...
                    function (e) {
                        ...
                        if ("string" == typeof e && !ke.test(e) && !ve[(he.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = w.htmlPrefilter(e);
                            try {
                                for (; n < r; n++)
        ...
        (tt.propHooks = {
            _default: {
                ...
                set: function (e) {
                    w.fx.step[e.prop]
                        ? w.fx.step[e.prop](e)
                        : 1 !== e.elem.nodeType || (!w.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)])
                        ? (e.elem[e.prop] = e.now)
    ...
    function at() {
        rt &&
            (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, w.fx.interval),
            w.fx.tick());
    }
    function st() {
        return (
                ...
                if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                    for (r in (f &&
                        ...
                        "none" === (c = w.css(e, "display")) &&
                            (l
                                ? (c = l)
                                : (ce([e], !0), (l = e.style.display || l), (c = w.css(e, "display")), ce([e]))),
                    ...
                    d))
                        u ||
                            ...
                            g && ce([e], !0),
                            p.done(function () {
                                for (r in (g || ce([e]), K.remove(e, "fxshow"), d)) w.style(e, r, d[r]);
                            })),
                            (u = lt(g ? v[r] : 0, r, p)),
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? w.prop(e, t, n)
                        : ((1 === o && w.isXMLDoc(e)) ||
                              (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ft : void 0)),
                          void 0 !== n
                              ? null === n
                    ...
                    : ((n = mt(e)),
                      this.each(function () {
                          if (s)
                              ...
                              (void 0 !== e && "boolean" !== a) ||
                                  ((r = vt(this)) && K.set(this, "__className__", r),
                                  this.setAttribute &&
                                      this.setAttribute(
                                          "class",
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, i) {
            ...
            if (
                ...
                if (!i && !p.noBubble && !g(r)) {
                    for (u = p.delegateType || y, xt.test(u + y) || (a = a.parentNode); a; a = a.parentNode)
                        m.push(a), (s = a);
                ...
                for (o = 0; (a = m[o++]) && !t.isPropagationStopped(); )
                    (d = a),
                        ...
                        (f = (K.get(a, "events") || Object.create(null))[t.type] && K.get(a, "handle")) &&
                            f.apply(a, n),
                        (f = l && a[l]) &&
                            f.apply &&
                            V(a) &&
            ...
            ajax: function (t, n) {
                ...
                d.hasContent
                    ...
                    : ((p = d.url.slice(i.length)),
                      ...
                      !1 === d.cache &&
                          ((i = i.replace(qt, "$1")), (p = (Ct.test(i) ? "&" : "?") + "_=" + Tt.guid++ + p)),
                      (d.url = i + p)),
                d.ifModified &&
                ...
                if (((C = "abort"), y.add(d.complete), E.done(d.success), E.fail(d.error), (r = It(Mt, d, n, E)))) {
    ...
    w.ajaxSetup({
            ...
            if (s || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    s
                        ...
                        : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        ...
        (d.createHTMLDocument =
            (((zt = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"),
        ...
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (i = D.exec(e))
                      ? [t.createElement(i[1])]
                      : ((i = be([e], t, o)), o && o.length && w(o).remove(), w.merge([], i.childNodes)));
            var r, i, o;
        }),
        ...
        w.each(["top", "left"], function (e, t) {
            w.cssHooks[t] = ze(d.pixelPosition, function (e, n) {
                if (n) return (n = _e(e, t)), Re.test(n) ? w(e).position()[t] + "px" : n;
            });
        }),
    ...
    return (
        (w.noConflict = function (t) {
            return e.$ === w && (e.$ = Kt), t && e.jQuery === w && (e.jQuery = Gt), w;
        }),
...
let key = { 1: "m", 2: "n", 3: "b", 4: "l", 5: "k", 6: "g" };
const regex =
        /Mã Số[ \\n\n]*(\d*) Họ Tên ([\w\W][^-]*)- Ngày sinh:([\d\/]*)[\n\\n -]*Lớp: ([\w\d]*) - Ngành: ([\w\d\W][^-]*)- Khoa: ([\w\d\W]*)/gm,
    getThoiKhoaBieu = (e) =>
        __awaiter(void 0, void 0, void 0, function* () {
            let e = 0;
            const t = [],
                n = {},
                r = $("#ctl00_ContentPlaceHolder1_ctl00_pnlTKB").text();
            let i;
            for (; null !== (i = regex.exec(r)); )
                i.index === regex.lastIndex && regex.lastIndex++,
                    i.forEach((e, t) => {
                        if (0 == t) return;
                        const r = key[t];
                        n[r] = e.trim();
                    });
            const o = $("div.grid-roll2>table.body-table>tbody>tr");
            for (let n = 0; n < o.length; n++) {
                const r = { lichHoc: [] };
                r.colors = colors[e++];
                const i = o[n],
                    a = $(">td:nth-child(2)", i).text().trim(),
                    s = $(">td:first-child", i).text().trim();
                r.maMH = s;
                const u = $(">td", i),
                    l = u[8],
                    c = $(">*", l);
                if (c && 0 != c.length) {
                    for (let e = 0; e < c.length; e++) r.lichHoc.push({ thu: $(c[e]).text().trim() });
                    const e = u[9],
                        t = $(">*", e),
                        n = u[10],
                        i = $(">*", n),
                    ...
                    for (let e = 0; e < t.length; e++) {
                        const n = t[e];
                        (r.lichHoc[e].tietBatDau = parseInt($(n).text())),
                            (r.lichHoc[e].tietKetThuc = parseInt($(i[e]).text())),
                            (r.lichHoc[e].phong = $(a[e]).text()),
                            (r.lichHoc[e].MSGV = $(l[e]).text());
                    }
                } else
                    r.lichHoc.push({ thu: z($(l).text()) }),
                        (r.lichHoc[0].tietBatDau = parseInt($(u[9]).text())),
                        (r.lichHoc[0].tietKetThuc = parseInt($(u[10]).text())),
                        (r.lichHoc[0].phong = $(u[11]).text()),
                        (r.lichHoc[0].MSGV = $(u[12]).text());
                (r.tenMH = a), t.push(r);
            }
            return {
                lichHoc: t.flatMap((e) =>
